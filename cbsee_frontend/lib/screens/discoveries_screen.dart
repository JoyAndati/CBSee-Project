...
// // lib/screens/discoveries_screen.dart

// import 'package:flutter/material.dart';
// import '../models/discovery_item.dart'; // Assuming you created the model

// // --- MOCK DATA: In a real app, this would come from a database or API ---
// final List<DiscoveryItem> mockDiscoveries = [
//   DiscoveryItem(id: 1, name: 'Spoon', imageUrl: 'assets/images/history.png', category: 'Kitchen', discoveredDate: DateTime.now()),
//   DiscoveryItem(id: 1, name: 'Spoon', imageUrl: 'assets/images/history.png', category: 'Kitchen', discoveredDate: DateTime.now()),
// ];
// // --------------------------------------------------------------------------
...
// class _DiscoveriesScreenState extends State<DiscoveriesScreen> with SingleTickerProviderStateMixin {
//   late TabController _tabController;
//   final TextEditingController _searchController = TextEditingController();
//   List<DiscoveryItem> _filteredDiscoveries = mockDiscoveries;
//   final List<String> _categories = ['All', 'Kitchen', 'Living Room', 'Outdoor'];
...
//     setState(() {
//       _filteredDiscoveries = mockDiscoveries.where((item) {
//         final matchesCategory = selectedCategory == 'All' || item.category == selectedCategory;
//         final matchesSearch = item.name.toLowerCase().contains(searchQuery);
//         return matchesCategory && matchesSearch;
//       }).toList();
...
//         ),
//       ),
//       // NOTE: You can add your main app's bottom navigation bar here
//     );
//   }
...
//         SizedBox(height: 4),
//         Text(
//           'View your past discoveries and progress.',
//           style: TextStyle(
//             fontSize: 16,
...
//       controller: _tabController,
//       children: _categories.map((_) {
//         // We use a single filtered list, so the view is always the same.
//         // The filtering happens in the listener.
//         if (_filteredDiscoveries.isEmpty) {
//           return const Center(
//             child: Text(
...
// // A reusable widget for displaying the grid of items
// class DiscoveryGrid extends StatelessWidget {
//   final List<DiscoveryItem> items;
//   const DiscoveryGrid({super.key, required this.items});
...
// // A reusable card widget for each discovered item
// class DiscoveryCard extends StatelessWidget {
//   final DiscoveryItem item;
//   const DiscoveryCard({super.key, required this.item});
